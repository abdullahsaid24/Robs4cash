...
import { Phone, Calendar, Car, Download, Search, ChevronLeft, ChevronRight } from 'lucide-react';
                                    ...
                                    {filteredLeads.map((lead) => (
                                        <tr key={lead.id} className="border-b border-white/5 hover:bg-white/5">
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                {lead.missing_parts === 'Yes' && (
                                                    <span className="ml-2 text-xs text-gray-500">(Missing parts)</span>
                                                )}
                                            </td>
                                            <td className="px-6 py-4">
                                                <a
                                                    href={`tel:${lead.phone}`}
                                                    className="inline-flex items-center gap-2 bg-brand-green text-brand-dark font-medium px-4 py-2 rounded-lg hover:brightness-110 transition-all text-sm"
                                                >
                                                    <Phone size={14} />
                                                    Call
                                                </a>
