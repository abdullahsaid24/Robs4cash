        ...
        <div className="max-w-4xl">
            ...
            <section className="bg-[#111] border border-white/10 rounded-xl p-6 mb-6">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm text-gray-400 mb-2">Title (Line 2 - Green text)</label>
                        <input
                            type="text"
            ...
            {/* Process Section */}
            <section className="bg-[#111] border border-white/10 rounded-xl p-6 mb-6">
                <h2 className="text-xl font-bold text-white mb-4">How It Works Section</h2>
                <div className="space-y-4">
                    <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm text-gray-400">Step 1 Title</label>
                            <input
                                type="text"
                                value={content.process.step1Title}
                                onChange={(e) => updateField('process', 'step1Title', e.target.value)}
                                className="w-full bg-[#0a0a0a] border border-white/10 text-white rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-brand-green outline-none"
                            />
                            <textarea
                        ...
                        {/* Step 2 */}
                        <div className="space-y-2">
                            <label className="block text-sm text-gray-400">Step 2 Title</label>
                            <input
                                type="text"
                        ...
                        {/* Step 3 */}
                        <div className="space-y-2">
                            <label className="block text-sm text-gray-400">Step 3 Title</label>
                            <input
                                type="text"
